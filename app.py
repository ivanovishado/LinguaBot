            ...
            for messaging_event in entry["messaging"]:
                ...
                if messaging_event.get("message"):
                    ...
                    if len(user) == 0:
                        ...
                        user = user[0]
                    ans = bot.reply(sender_id, message_text)
...
if __name__ == '__main__':
    p = argparse.ArgumentParser("pyRiveScript")
    ...
    p.add_argument("--port", default=5000, type=int,
                   ...
                   help="Port url [500]")
    p.add_argument("--rs", default="./rs", type=str,
                   action="store", dest="rs",
                   help="RiveScript directory with rules [./rs]")
    p.add_argument("--debug", default=False,
                   action="store_true", dest="debug",
                   help="Use debug deployment [False]")
